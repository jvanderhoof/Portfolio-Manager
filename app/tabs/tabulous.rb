...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #---------------------------------------------------------------------------------------------------------------------------#
      [ :user_edit_tab            ,    'Your Information'          ,    edit_account_path(1)      ,    true        ,    true     ],
      [ :user_show_tab            ,    'Allocations'               ,    accounts_path             ,    true        ,    true     ],
      [ :investment_account_tab   ,    'Accounts'                  ,    investment_accounts_path  ,    true        ,    true     ],
      [ :plan_tab                 ,    'Investment Plan'           ,    plans_path                ,    true        ,    true     ],
      [ :investment_companies_tab ,    'Investment Companies'      ,    investment_account_companies_path,    true        ,    true     ],
      [ :investment_plans_tab     ,    'Advanced Investment Plans' ,    investment_plans_path     ,    true        ,    true     ],
      [ :portfolios_tab           ,    'Portfolios'                ,    portfolios_path           ,    true        ,    true     ],
      #---------------------------------------------------------------------------------------------------------------------------#
      # TAB NAME                 |    DISPLAY TEXT                |    PATH                      |    VISIBLE?    |    ENABLED?   #
      #---------------------------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      #------------------------------------------------------------------------------#
      [    :portfolios           ,    :all_actions    ,    :portfolios_tab           ],
      [    :investment_plans     ,    :all_actions    ,    :investment_plans_tab     ],
      [    :investment_accounts_plans     ,    :all_actions    ,    :investment_accounts_tab     ],
      [    :portfolios           ,    :all_actions    ,    :portfolios_tab           ],
      [    :accounts                ,    :edit           ,    :user_edit_tab            ],
      [    :accounts                ,    :show           ,    :user_show_tab            ],
      [    :plans                ,    :all_actions    ,    :plan_tab                 ],
      [     :investment_account_companies, :all_actions, :investment_companies_tab],
      #------------------------------------------------------------------------------#
      #    CONTROLLER            |    ACTION          |    TAB                       #
      #------------------------------------------------------------------------------#
    ]
    # [    :investment_assets    ,    :all_actions    ,    :investment_assets_tab    ],
